...
<body>
    ...
    <ul class="header_login">
        <li><a href="<%=request.getContextPath()%>/index.jsp" style="color: orangered;font-size: 24px;position: relative;left: 50px;top: 5px">简·简书</a></li>
        ...
        <li name="login_simple"><a href="<%=request.getContextPath()%>/login.html" style="color:#b0b0b0;position: relative;left: 300px;top: 5px;font-size: 20px;">登录</a></li>
        <li>
            <button type="button" class="layui-btn layui-btn-primary layui-btn-radius" onclick="location.href='<%=request.getContextPath()%>/register.html'"
                    style="color: orangered;position: relative;left: 350px">注册
            </button>
        </li>
        <li>
            <button type="button" class="layui-btn layui-btn-danger layui-btn-radius" onclick="location.href='<%=request.getContextPath()%>/writePost.jsp'"
